...
if __name__ == "__main__":
    ...
    print("\n", time.ctime())
    print(
        f'    Loading {params["city"]} data: {start}~{end}, '
    ...
    # get data loader
    data_generator = Data_Container.DataGenerator(
        obs_len=params["obs_len"], pred_len=params["pred_len"], data_split_ratio=params["split_ratio"]
    )
    ...
    trainer.test(data_loader=data_loader, modes=["test"])
